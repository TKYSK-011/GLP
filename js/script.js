...
document.querySelectorAll('.short-card, .long-card').forEach(card => {
    card.addEventListener('click', () => {
        ...
        alert('この機能は実際のYouTube動画URLにリンクできます');
...
if (copyrightElement) {
    copyrightElement.textContent = `© ${currentYear} Engineer's Playground. All rights reserved.`;
}
...
console.log('%c🎬 エンジニアの遊び場', 'font-size: 20px; font-weight: bold; color: #3b82f6;');
console.log('%cYouTubeチャンネルをご覧いただきありがとうございます！', 'font-size: 14px; color: #8b5cf6;');
console.log('%c技術に興味がある方、ぜひチャンネル登録をお願いします！', 'font-size: 12px; color: #06b6d4;');
